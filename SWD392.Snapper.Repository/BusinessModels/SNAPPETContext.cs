...
public partial class SNAPPETContext : DbContext
{
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=ntl-db-sql.database.windows.net;Initial Catalog=SNAPPET;Persist Security Info=True;User ID=nguyentuanloc;Password=123@a123A;Encrypt=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Package>(entity =>
        {
            ...
            entity.HasOne(d => d.User).WithMany(p => p.Packages)
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Package__UserID__778AC167");
        });
        ...
        modelBuilder.Entity<Pet>(entity =>
        {
            ...
            entity.HasOne(d => d.Owner).WithMany(p => p.Pets)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Pets__OwnerID__04E4BC85");
        });
        ...
        modelBuilder.Entity<Post>(entity =>
        {
            ...
            entity.HasOne(d => d.User).WithMany(p => p.Posts)
                .HasForeignKey(d => d.UserId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Posts__UserID__1332DBDC");
        });
        ...
        {
            entity.HasKey(e => e.UserId).HasName("PK__Users__1788CCAC4CA98B37");
